...
La instancia en [vadelivery.vercel.app](https://vadelivery.vercel.app) está **en producción con un cliente real**, así que sólo se puede recorrer la UI del marketplace en modo navegación (home, fichas de comercio, catálogo, carrito) — no se realizan pedidos de prueba para no contaminar la base del cliente.
