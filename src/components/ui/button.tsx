  ...
  ),
  {
    variants: {
      variant: {
        ...
        secondary: "bg-neutral-100 dark:bg-neutral-800 text-neutral-900 dark:text-neutral-100 hover:bg-neutral-200 dark:hover:bg-neutral-700 hover:-translate-y-0.5",
        outline: "border border-primary-600 bg-white dark:bg-neutral-900 text-primary-600 hover:bg-primary-50 dark:hover:bg-primary-950/30 hover:-translate-y-0.5",
        dark: "bg-neutral-900 dark:bg-neutral-100 text-white dark:text-neutral-900 hover:bg-neutral-800 dark:hover:bg-neutral-200 hover:-translate-y-0.5",
        ...
        ghost: "text-neutral-700 dark:text-neutral-300 hover:bg-neutral-100 dark:hover:bg-neutral-800 hover:-translate-y-0.5",
