...
export default function CarritoPage() {
  ...
  if (items.length === 0) {
    return (
      <div className="container-shop py-12 text-center">
        ...
        <h1 className="text-heading-lg font-semibold text-neutral-900 dark:text-neutral-100 mb-2">
  ...
  return (
    <div className="container-shop py-4 pb-10">
      ...
      <ul className="space-y-2.5 mb-6">
        {items.map((item) => {
          ...
          return (
            <li
              key={item.lineId}
              className="bg-white dark:bg-neutral-900 rounded-md border border-neutral-300 dark:border-neutral-700 p-3 flex gap-3"
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-body-sm text-neutral-700 dark:text-neutral-300 mt-1">
                ...
                <div className="flex items-center justify-between mt-2">
                  <div className="flex items-center gap-1 bg-neutral-100 dark:bg-neutral-800 rounded-md p-0.5">
                    ...
                    <span className="px-2 text-body-sm font-medium min-w-[24px] text-center text-neutral-900 dark:text-neutral-100">
                      {item.quantity}
                    </span>
                    <button
      ...
      {/* Resumen */}
      <div className="bg-white dark:bg-neutral-900 rounded-md border border-neutral-300 dark:border-neutral-700 p-4 space-y-2">
        ...
        <div className="flex justify-between text-body-md">
          ...
          <span className={deliveryFee === 0 ? "text-accent-600 font-medium" : "text-neutral-900 dark:text-neutral-100"}>
